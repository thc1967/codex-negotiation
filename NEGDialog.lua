...
--- Raise the Director's window, selecting one negotiation if given.
--- @param defid string|nil
function NEGDialog.Open(defid)
...
local function CreateCelebrationOverlay(report)
    return THCWidgets.CelebrationOverlay(NEGEndingPanel.CreateCelebration(report))
end
